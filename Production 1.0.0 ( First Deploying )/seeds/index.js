...
const insertDB = async function () {
    for (let index = 0; index < 200; index++) {
        ...
        const camp = new Campground({
            ...
            images: [
                {
                    url: "https://res.cloudinary.com/dypcebyz9/image/upload/v1694772972/samples/landscapes/nature-mountains.jpg",
                    filename: "Campsite Explorer/xc0aakteknbrzyqrrobb"
                },
                {
